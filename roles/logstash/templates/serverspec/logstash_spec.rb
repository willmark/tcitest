...
# When updating serverspec checks, be sure to update techspecs accordingly:
# https://github.ibm.com/BlueBoxDocs/IBM-Blue-Box-Docs
...
describe file('/etc/logstash/ssl/logstash.key') do
  it { should be_mode 640 }	#LST026
  it { should be_owned_by 'root' }	#LST027
  it { should be_grouped_into 'logstash' }	#LST028
  it { should be_file }	#LST029
end

describe file('/etc/logstash/ssl/logstash.pem') do
